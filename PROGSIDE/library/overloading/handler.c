...
#define I2C_DATASHEET_ADDRESS_COMPASS 0x32
#define I2C_DATASHEET_ADDRESS_ARDUINO 0x07
...
static int readBlocks(uint8_t  *block,int length){
    ...
    block[8] = I2C_DATASHEET_ADDRESS_ARDUINO;//handlers.shdata->shdata_arduino.address_arduino;
...
static int readOneCompassByte(){
   ...
   switch (readingProccess) {
     ...
     case COM_POST_ACCEL:return_value = handlers.shdata->shdata_compass.accelVector[stepInReadingProcess++];
         break;
     case REG_SLAVE_ADDRESS:return_value = I2C_DATASHEET_ADDRESS_COMPASS;//handlers.shdata->shdata_compass.address_compass;
         break;
